...
if gui_data ~= nil then
	if currentver ~= gui_data.ver or gui_data.ver ~= currentver then
		warnmessage("AZUMA CLIENT"..currentver, "You are using an outdated version of this script", "Loading latest version.", 10) 
...
normalmessage("AZUMA CLIENT"..currentver, "Loading script...", "", 2)
if gui_data ~= nil then
	oldnormalmessage("INFO", gui_data.changelog, 20)
end

-- credits azuma and xcserec
...
if isfolder and makefolder and listfiles and writefile and delfile then
	local AZUMA_CLIENT_FOLDER_NAME = "AZUMA CLIENT"
